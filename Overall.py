...
st.write(df_selected_1.sort_values(by = ['risk_index'], ascending = False).style.hide_index())
...
st.write(df_selected_2.sort_values(by = ['risk_index'], ascending = False).style.hide_index())
